...
#### --------------    Bring in data   -------------- ####
################################################################################
GPS_Dist <- readRDS("W:/VF/2024/animal behaviour data/Pinnaroo2021/data_prep/VF3_step4.rds")
...
start <- min(GPS_Dist$local_time, na.rm = TRUE)  # "2021-10-12 09:03:00 ACDT"
end <-   max(GPS_Dist$local_time, na.rm = TRUE) # "2021-10-17 09:33:00 ACDT"
...
start <- round_date(start, unit="10 mins") #2021-10-12 09:00:00 ACDT"
end <- round_date(end, unit="10 mins") # "2021-10-17 09:30:00 ACDT"
...
saveRDS(regular_time_interval,  "W:/VF/2024/animal behaviour data/Pinnaroo2021/data_prep/VF3_regular_time_interval.rds")
...
saveRDS(GPS_animal_reg_time_step_all,  "W:/VF/2024/animal behaviour data/Pinnaroo2021/data_prep/VF3_step5.rds")


# write.csv(GPS_animal_reg_time_step9370004,
#           "W:/VF/2024/animal behaviour data/Pinnaroo2021/data_prep/checking_step3_VF3/WED_GPS_animal_reg_time_step9370004.csv")
