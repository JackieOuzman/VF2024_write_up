...
GPS_Dist <- readRDS("W:/VF/2024/animal behaviour data/Pinnaroo2021/data_prep/VF3step3_clip.rds")
names(GPS_Dist)
...
#           paste0("W:/VF/2024/animal behaviour data/Pinnaroo2021/data_prep/checking_step3_VF3/WED_step5b_Greg_time_step_dist_travelled_withCue.csv"), 
#           row.names=FALSE)
...
#           paste0(output_path,"/step5b_reg_time_step_dist_travelled_withCue_VF3.csv"), 
#           row.names=FALSE)

saveRDS(GPS_animal_reg_time_step_all,  "W:/VF/2024/animal behaviour data/Pinnaroo2021/data_prep/VF3_step5b.rds")
