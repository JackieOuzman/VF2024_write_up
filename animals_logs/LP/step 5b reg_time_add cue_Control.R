...
GPS_Dist <- readRDS("W:/VF/2024/animal behaviour data/Long Plain/data_prep/control_step3_clip.rds")
names(GPS_Dist)
...
rm(GPS_animal_reg_time_step9370124,
   GPS_animal_reg_time_step9380134,
   GPS_animal_reg_time_step9380196,
   GPS_animal_reg_time_step9380310,
   GPS_animal_reg_time_step9380332,
...
saveRDS(GPS_animal_reg_time_step_all,  "W:/VF/2024/animal behaviour data/Long Plain/data_prep/Control_step5b.rds")
