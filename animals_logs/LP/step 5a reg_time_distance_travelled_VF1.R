...
#### --------------    Bring in data   -------------- ####
################################################################################
GPS_Dist <- readRDS("W:/VF/2024/animal behaviour data/Long Plain/data_prep/VF1_step4.rds")
...
start <- round_date(start, unit="10 mins") #2020-10-21 15:00:00 ACDT"
end <- round_date(end, unit="10 mins") # "2020-10-25 10:50:00 ACDT"
...
saveRDS(regular_time_interval,  "W:/VF/2024/animal behaviour data/Long Plain/data_prep/VF1_regular_time_interval.rds")
