...
#### --------------    Bring in data   -------------- ####
################################################################################
GPS_Dist <- readRDS("W:/VF/2024/animal behaviour data/Long Plain/data_prep/VF4_step4.rds")
...
start <- min(GPS_Dist$local_time, na.rm = TRUE)  # "2020-11-03 11:57:00 ACDT"
end <-   max(GPS_Dist$local_time, na.rm = TRUE) # "2020-11-09 08:57:16 ACDT"
...
start <- round_date(start, unit="10 mins") #2020-11-03 12:00:00 ACDT"
end <- round_date(end, unit="10 mins") # "2020-11-09 09:00:00 ACDT"
...
saveRDS(regular_time_interval,  "W:/VF/2024/animal behaviour data/Long Plain/data_prep/VF4_regular_time_interval.rds")
...
saveRDS(GPS_animal_reg_time_step_all,  "W:/VF/2024/animal behaviour data/Long Plain/data_prep/VF4_step5.rds")
