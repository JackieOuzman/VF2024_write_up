...
GPS_Dist <- readRDS("W:/VF/2024/animal behaviour data/Long Plain/data_prep/VF3step3_clip.rds")
names(GPS_Dist)
...
saveRDS(GPS_animal_reg_time_step_all,  "W:/VF/2024/animal behaviour data/Long Plain/data_prep/VF3_step5b.rds")
