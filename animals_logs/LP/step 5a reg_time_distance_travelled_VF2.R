...
#### --------------    Bring in data   -------------- ####
################################################################################
GPS_Dist <- readRDS("W:/VF/2024/animal behaviour data/Long Plain/data_prep/VF2_step4.rds")
...
start <- min(GPS_Dist$local_time, na.rm = TRUE)  # "2020-10-25 10:57:00 ACDT"
end <-   max(GPS_Dist$local_time, na.rm = TRUE) # "2020-10-30 08:01:53 ACDT"
...
start <- round_date(start, unit="10 mins")  #"2020-10-25 11:00:00 ACDT"
end <- round_date(end, unit="10 mins") # 2020-10-30 08:00:00 ACDT"
...
saveRDS(regular_time_interval,  "W:/VF/2024/animal behaviour data/Long Plain/data_prep/VF2_regular_time_interval.rds")
...
saveRDS(GPS_animal_reg_time_step_all,  "W:/VF/2024/animal behaviour data/Long Plain/data_prep/VF2_step5.rds")
