...
VF_animal_GPS_data <- read_csv("W:/VF/2024/animal behaviour data/Pinnaroo2022/data_prep/XYtrial_csiro_pinnaroo_mob_274_control_mob_filtered_GDA.csv")
...
VF_animal_GPS_data <- VF_animal_GPS_data %>% 
    mutate(GMT = ymd_hms(timeOfEven_v1, tz = "GMT"))
...
##########################################################################################################
## save files ###
saveRDS(VF_animal_GPS_data,              "W:/VF/2024/animal behaviour data/Pinnaroo2022/data_prep/control.rds")
