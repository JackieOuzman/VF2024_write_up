...
ggplot() +
  ...
  geom_sf(data = VF_fence_VF1, color = "black", fill = NA) +
...
saveRDS(GPS_sf_trans_VF1_clip_df,  "W:/VF/2024/animal behaviour data/Pinnaroo2022/data_prep/VF1step3_clip.rds")
...
step1_2_sf_clip_VF2 <-
 ...
 ggplot() +
   geom_sf(data = Hard_fence_bound, color = "black", fill = NA) +
   #geom_sf(data = VF_fence_bound, color = "black", fill = NA) +
   #geom_sf(data = VF2_paddock, color = "black", fill = NA) +
   geom_sf(data = VF_fence_VF2, color = "black", fill = NA) +
...
saveRDS(step1_2_sf_clip_VF2_df,  "W:/VF/2024/animal behaviour data/Pinnaroo2022/data_prep/VF2step3_clip.rds")
...
ggplot() +
  geom_sf(data = Hard_fence_bound, color = "black", fill = NA) +
  #geom_sf(data = VF_fence_bound, color = "black", fill = NA) +
  #geom_sf(data = VF3_paddock, color = "black", fill = NA) +
  geom_sf(data = VF_fence_VF3, color = "black", fill = NA) +
  
   geom_sf(data = step1_2_sf_clip_VF3 ,alpha = 0.01) +
   theme_bw()+
...
saveRDS(step1_2_sf_clip_VF3_df,  "W:/VF/2024/animal behaviour data/Pinnaroo2022/data_prep/VF3step3_clip.rds")
...
unique(step1_4VF_No_NA_NULL$fencesID)
 ...
 ggplot() +
   geom_sf(data = Hard_fence_bound, color = "black", fill = NA) +
   #geom_sf(data = VF_fence_bound, color = "black", fill = NA) +
   #geom_sf(data = VF4_paddock, color = "black", fill = NA) +
   geom_sf(data = VF_fence_VF4, color = "black", fill = NA) +
...
## convert the geom clm into x and y clms
 ...
 saveRDS(step1_2_sf_clip_VF4_df,  "W:/VF/2024/animal behaviour data/Pinnaroo2022/data_prep/VF4step3_clip.rds")
...
step1_5VF <-  readRDS(paste0(path_step1, "VF5.rds"))
...
#To the large block boundary with buffer
GPS_sf_trans_5VF_clip <-
  st_intersection(GPS_sf_trans_5VF, st_difference(Hard_fence_bound)) #this 'st_difference' function is supposed to remove the duplication

step1_5VF_NULL <- GPS_sf_trans_5VF_clip %>% filter(fencesID == "NULL")
step1_5VF_NA <- GPS_sf_trans_5VF_clip %>% filter(is.na(fencesID)) 
step1_5VF_No_NA_NULL <- GPS_sf_trans_5VF_clip %>% filter(!is.na(fencesID)) %>% filter(fencesID != "NULL") 

unique(step1_5VF_No_NA_NULL$fencesID)

ggplot() +
  geom_sf(data = Hard_fence_bound, color = "black", fill = NA) +
  #geom_sf(data = VF_fence_bound, color = "black", fill = NA) +
  #geom_sf(data = VF5_paddock, color = "black", fill = NA) +
  geom_sf(data = VF_fence_VF5, color = "black", fill = NA) +
  
  geom_sf(data = GPS_sf_trans_5VF_clip ,alpha = 0.03) +
  #geom_sf(data = step1_4VF_No_NA_NULL ,color = "pink") +
...
coordinates <-as.data.frame( st_coordinates(GPS_sf_trans_5VF_clip))
step1_2_sf_clip_VF5_df <- as.data.frame(GPS_sf_trans_5VF_clip)

step1_2_sf_clip_VF5_df <- step1_2_sf_clip_VF5_df %>% 
  dplyr::select(-"geometry")


step1_2_sf_clip_VF5_df <-   cbind(step1_2_sf_clip_VF5_df,coordinates )

saveRDS(step1_2_sf_clip_VF5_df,  "W:/VF/2024/animal behaviour data/Pinnaroo2022/data_prep/VF5step3_clip.rds")
...
rm(list=ls()[! ls() %in% c("Hard_fence_bound","VF_fence_bound","Hard_fence_bound_VF",
                           "path_step1",
                           "GPS_sf_trans_VF5_clip_df",
                           "step1_2_sf_clip_VF5_df",
                           "step1_2_sf_clip_df",
                           "GPS_sf_trans_De_VF_clip_df",
                           "VF_fence_VF1",
                           "VF_fence_VF2",
...
step1_6VF <-  readRDS(paste0(path_step1, "VF6.rds"))
...
#To the large block boundary with buffer
GPS_sf_trans_6VF_clip <-
  st_intersection(GPS_sf_trans_6VF, st_difference(Hard_fence_bound)) #this 'st_difference' function is supposed to remove the duplication

step1_6VF_NULL <- GPS_sf_trans_6VF_clip %>% filter(fencesID == "NULL")
step1_6VF_NA <- GPS_sf_trans_6VF_clip %>% filter(is.na(fencesID)) 
step1_6VF_No_NA_NULL <- GPS_sf_trans_6VF_clip %>% filter(!is.na(fencesID)) %>% filter(fencesID != "NULL") 

unique(step1_6VF_No_NA_NULL$fencesID)

ggplot() +
  geom_sf(data = Hard_fence_bound, color = "black", fill = NA) +
  #geom_sf(data = VF_fence_bound, color = "black", fill = NA) +
  #geom_sf(data = VF6_paddock, color = "black", fill = NA) +
  geom_sf(data = VF_fence_VF6, color = "black", fill = NA) +
  
  geom_sf(data = GPS_sf_trans_6VF_clip ,alpha = 0.03) +
  #geom_sf(data = step1_4VF_No_NA_NULL ,color = "pink") +
...
coordinates <-as.data.frame( st_coordinates(GPS_sf_trans_6VF_clip))
step1_2_sf_clip_VF6_df <- as.data.frame(GPS_sf_trans_6VF_clip)

step1_2_sf_clip_VF6_df <- step1_2_sf_clip_VF6_df %>% 
  dplyr::select(-"geometry")


step1_2_sf_clip_VF6_df <-   cbind(step1_2_sf_clip_VF6_df,coordinates )

saveRDS(step1_2_sf_clip_VF6_df,  "W:/VF/2024/animal behaviour data/Pinnaroo2022/data_prep/VF6step3_clip.rds")
