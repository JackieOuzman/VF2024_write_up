...
#### --------------    Bring in data   -------------- ####
################################################################################
GPS_Dist <- readRDS("W:/VF/2024/animal behaviour data/Pinnaroo2022/data_prep/VF6_step4.rds")
...
saveRDS(regular_time_interval,  "W:/VF/2024/animal behaviour data/Pinnaroo2022/data_prep/VF6_regular_time_interval.rds")
...
saveRDS(GPS_animal_reg_time_step_all,  "W:/VF/2024/animal behaviour data/Pinnaroo2022/data_prep/VF6_step5.rds")


# write.csv(GPS_animal_reg_time_step9370004,
#           "W:/VF/2024/animal behaviour data/Pinnaroo2022/data_prep/checking_step3_VF6/WED_GPS_animal_reg_time_step9370004.csv")
