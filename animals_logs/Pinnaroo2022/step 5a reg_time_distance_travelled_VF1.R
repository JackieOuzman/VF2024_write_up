...
#### --------------    Bring in data   -------------- ####
################################################################################
GPS_Dist <- readRDS("W:/VF/2024/animal behaviour data/Pinnaroo2022/data_prep/VF1_step4.rds")
...
start <- min(GPS_Dist$local_time, na.rm = TRUE)  # "2022-07-20 14:53:00 ACDT"
end <-   max(GPS_Dist$local_time, na.rm = TRUE) # "2022-07-22 11:53:00 ACDT"
...
saveRDS(regular_time_interval,  "W:/VF/2024/animal behaviour data/Pinnaroo2022/data_prep/VF1_regular_time_interval.rds")
...
saveRDS(GPS_animal_reg_time_step_all,  "W:/VF/2024/animal behaviour data/Pinnaroo2022/data_prep/VF1_step5.rds")


# write.csv(GPS_animal_reg_time_step9370004,
#           "W:/VF/2024/animal behaviour data/Pinnaroo2022/data_prep/checking_step3_VF1/WED_GPS_animal_reg_time_step9370004.csv")
