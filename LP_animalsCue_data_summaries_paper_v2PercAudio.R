...
LP_VF_no_control_summary_percet_audio <- VF_no_control %>%
  group_by(VF) %>%
  summarise(
...
LP_VF_no_control_summary_percet_audio


LP_no_control_summary_percet_audio <- VF_no_control %>%
  group_by() %>%
  summarise(
    mean_percet_audio = mean(percet_audio, na.rm = TRUE),
...
LP_no_control_summary_percet_audio
